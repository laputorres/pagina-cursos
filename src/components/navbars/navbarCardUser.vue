...
<div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" class="inline-block mb-6 rounded-full bg-gray-300 pr-5 h-16 line-height-[3.75rem]" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <img class="rounded-full float-left h-full" src="https://www.w3schools.com/howto/img_avatar.png" alt="user photo">
        <span class="texto-[16px]">{{ nombreUsuarioLogeado }}</span>
      </button>
      <!-- Dropdown menu -->
