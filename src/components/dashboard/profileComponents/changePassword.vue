<template>
    <div>
        ...
        <form @submit.prevent="changePassword">
            ...
            <fwb-input v-model="newPassword" class="text-start mb-2" placeholder="New password" label="New password"  required/>
        ...
        <fwb-alert v-if="showSuccessAlert" class="fixed bottom-[3%] right-[3%] w-[30vw] p-4 text-lg text-white rounded-lg bg-blue-500" closable icon type="success">
