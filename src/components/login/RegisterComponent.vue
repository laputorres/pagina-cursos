            ...
            <div class="rounded-xl bg-white w-8/12 m-auto shadow-xl">
              <div class="p-6 sm:p-16">
                <div class="space-y-4">
                  ...
                  <h2 class="mb-1 text-2xl text-cyan-900 font-bold">Register</h2>
                </div>
...
hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                ...
                <form @submit.prevent="register" class="mb-30">
                  ...
                  <button type="submit" class="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
  hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                    <div class="relative flex items-center space-x-4 justify-center">
                      <span
