  ...
  <div>
    ...
    <main class="profile-page">
      <section class="relative block" style="height: 500px;">
        <div class="absolute top-0 w-full h-full bg-center bg-cover bg-gradient-to-r from-cyan-600 to-sky-700">
            ...
            <div class="px-6">
              <div class="flex flex-wrap justify-center">
                <div class="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                  <div class="relative">
                    <img alt="..." :src="userData.imgSrc || urlDefaultImage"
                  ...
                  <div class="flex justify-center py-4 lg:pt-4 pt-8">
                    <div class="mr-4 p-3 text-center">
                      <span class="text-xl font-bold block uppercase tracking-wide text-gray-700">22</span><span
                        class="text-sm text-gray-500">Curses</span>
                    </div>
                    <div class="mr-4 p-3 text-center">
              ...
              <div class="text-center mt-12">
                <h3 class="text-4xl font-semibold leading-normal mb-2 text-gray-800 mb-2">
                  {{userData.nombreUsuarioLogeado}} {{ userData.lastnameUsuarioLogeado }}
                </h3>
...
export default {
  ...
  if (!creationTime) return 'Fecha no disponible'; // Muestra un mensaje alternativo si no hay fecha
  const date = new Date(creationTime);
  return date.toLocaleDateString(); // Formatea la fecha si está disponible
};


    console.log("userData value in profile: ", userData)
  return{
    userData,
    formatDate
  }
