<template>
        ...
        <section class="h-screen">
            <div class="h-full">
                ...
                <div class="g-6 flex h-full flex-wrap items-center  justify-center lg:justify-between">
                    <div
                        class="shrink-1 mb-12 grow-0 basis-auto md:mb-0 bg-gray-400 h-full flex md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
                    ...
                    <div class="">
                        <div class="rounded-xl bg-white w-8/12 m-auto shadow-xl">
      <div class="p-6 sm:p-16">
        <div class="space-y-4">

          <h2 class="mb-1 text-2xl text-cyan-900 font-bold">Sign in</h2>
        </div>
 ...
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
            <div class="relative flex items-center space-x-4 justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="absolute left-0 w-5 text-gray-700"
                viewBox="0 0 16 16">
                <path
        ...
        <div
          ...
          <p class="mx-4 mb-0 text-center font-semibold dark:text-gray">
            Or
          </p>
        </div>

        <!-- Formulario -->
<form @submit.prevent="iniciarSesion" class="mb-30">
  ...
  >
    <div class="relative flex items-center space-x-4 justify-center">
      <span
        ...
        <div class="mt-33 space-y-4 text-gray-600 text-center sm:-mb-8">
          <p class="text-xs">By proceeding, you agree to our <a href="#" class="underline">Terms of Use</a> and
            confirm you have read our <a href="#" class="underline">Privacy and Cookie Statement</a>.</p>
          <p class="text-xs">This site is protected by reCAPTCHA and the <a href="#" class="underline">Google
              Privacy Policy</a> and <a href="#" class="underline">Terms of Service</a> apply.</p>
        </div>
      </div>
    </div>
                        ...
                        <p class="mb-0 mt-2 pt-1 text-sm font-semibold"> Lost your password?</p>
                    </div>
                </div>
            </div>
        </section>
